...
# name, address, email, phone, adharno, bssid, val(0, 1, 2), graphName
...
#   s.append(s1)
#   data["bssid"] = str(s1)
#   data["adharno"] = str(randoman())
#   data["lat"] = str(18.5204)
#   data["long"] = str(73.8567)
#   data["name"] = names[x]
#   data["address"] = "P-2,Dhayari,Kasba,Pune,Maharashtra"
#   data["phone"] = "901928902"
#   data["email"] = names[x].replace(' ', '') + "@gmail.com"
#   addUser(data)
