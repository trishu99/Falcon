  ...
  return (
    ...
    <MDBFooter color="blue" className="font-small pt-4 mt-4">
      <MDBContainer fluid className="text-center text-md-left">
        <MDBRow>
          <MDBCol md="5">
            <h2 className="text-light">FALCON</h2>
            <p className="text-light"><b>
              FASTEST NETWORK TO KNOW ALL COVID-19 SUSPECTS
            </b></p>
          </MDBCol>
          <MDBCol md="2">
          ...
          &copy; {new Date().getFullYear()} COPYRIGHT : <a href="https://www.mdbootstrap.com" className="text-light"> FALCON </a>
        </MDBContainer>
          </MDBCol>
